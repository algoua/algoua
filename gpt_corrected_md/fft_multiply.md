...
Дано дві рядка, задані як два булевих (тобто числових зі значеннями 0 або 1) масиви $a[]$ і $b[]$. Потрібно знайти всі такі позиції на першій рядку, що якщо прикласти, починаючи з цієї позиції, одну рядок, то ні в якому місці не вийде значення $\rm true$ на обох рядокх. Цю задачу можна переформулювати таким чином: дана карта рядка, в вигляді 0/1 - можна вставляти в цю клітинку або ні, і дана деяка фігурка в вигляді шаблону (в вигляді масиву, в якому 0 - немає клітини, 1 - є), потрібно знайти всі позиції в рядку, до яких можна прикласти фігурку.
