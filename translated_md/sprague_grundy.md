...
**Умова**. Є доска розміру $n \times m$: $n$ стрічок і $m$ стовпців. В кожної рядка стоять по дві фішки: одна чёрная і одна белая. За один хід гравець можливо взяти будь-яку фішку свого кольори і подвинуть її всередині рядка вправо або вліво на довільне число кроків, але не перепрыгивая через іншу фішку (і не вставая на її). Програє той, хто не можливо зробити ходу.

**Розв'язок**. По-перше, зрозуміло, що кожна з $n$ стрічок дошки утворює независимую гру. Тому задача зводиться до анализу гри в однієї рядка, а відповіддю на задачу буде XOR-сума значень Шпрага-Гранді для кожної з стрічок.

Решая задачу для однієї рядка, позначимо через $x$ відстань між чёрной і білою фишкой (яке можливо змінюватися від нуля до $m-2$). За один хід кожний гравець можливо або зменшити $x$ на деякий довільне значення, або, можливо, збільшити його до деякого значення (збільшення доступны не завжди). Таким чином, ця гра - це **"ним з збільшеннями"**, і, як ми вже знаємо, збільшення в цій грі бесполезны. Отже, функція Гранді для однієї рядка - це і є це відстань $x$.
