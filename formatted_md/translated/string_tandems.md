...
* Відомо, що якщо розглядати тільки примитивные тандемні повтори (тобто такі, половинки яких не є кратными рядками), то їх кількість в будь-якої стрічки - $O(n \log n)$.
